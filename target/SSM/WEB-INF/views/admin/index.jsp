...
<div class="layui-layout layui-layout-admin">
    <div class="layui-header" id="layerDemo">
        <div class="layui-logo">众创空间自主预约后台管理</div>
        <!-- 头部区域（可配合layui已有的水平导航） -->
        <p style="visibility: hidden" id="userId">${account.id}</p>
    ...
    <div class="layui-side layui-bg-black">
        <div class="layui-side-scroll">
            ...
            <ul class="layui-nav layui-nav-tree"  lay-filter="test">
                ...
                <%--<li class="layui-nav-item"><a href="ContactList.aspx">联系人管理</a></li>--%>
            </ul>
            <c:if test="${account.adminClass==1}">
                <ul class="layui-nav layui-nav-tree"  lay-filter="test">
